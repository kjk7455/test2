...
#saver.restore(sess, 'E:/LEGO/lego2019_10_06')
saver.restore(sess, 'E:/LEGO/lego3')
image = np.array(Image.open('C:\\Users\\Aluminum\\PycharmProjects\\lego\\test\\IMG_1916_1.jpg').convert('L'))
